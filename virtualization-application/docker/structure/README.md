...
<img src="./image/001.jpg" alt="docker" height="75%" width="75%">
...
<img src="./image/002.jpg" alt="image" height="50%" width="50%">
...
<!--
A Docker image is built up from a series of layers. Each layer represents an instruction in the image’s Dockerfile. Each layer except the very last one is read-only. Each layer is only a set of differences from the layer before it. The layers are stacked on top of each other. 
-->

## Container

<img src="./image/003.jpg" alt="image" height="75%" width="75%">
